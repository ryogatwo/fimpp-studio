...
object Trollestia extends ErrorMessageProvider {
  def syntaxError(functionName: String) =
    "Now say, do you like mmm-syntax errors? \n You have one in function ‘" +
    functionName + "’ after all. \n No? So let me get it straight: " +
  ...
  def mismatchedFunctionNameInFooter(expected: String, found: String) =
    "This function is a changeling! \n At the beginning it was named ‘" +
    expected + "’, and now it's ‘" + found + "’!"

  def unknownError = "To the moon with that code!"

  def invalidIdentifier(id: String) =
    "‘" + id.capitalize + "’ ain't no pony I've heard of. \n   Do they have tea parties with ‘" + id.capitalize + "’?"

  def kwError = "invalid Keyword "
