...
Reading fields (updated, added from- JCM)
------------

    I (took|got|stole) <field name> (of|from) <identifier: class or object> and {I} gave (it|them|her|him) to <identifier: target variable to store result> .
