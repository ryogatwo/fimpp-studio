...
Font − / + toolbar buttons resize the editor from 10 to 40 points. The chosen size is remembered for new letters and future launches. Reference body text and code examples are larger.
