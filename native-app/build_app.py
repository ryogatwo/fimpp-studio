...
for arch in ['arm64','x86_64']:
 subprocess.check_call(['xcrun','swiftc','-O','-swift-version','5','-module-cache-path',str(BUILD/('ModuleCache-'+arch)),'-module-name','FiMStudio','-target',arch+'-apple-macosx12.0','-framework','AppKit','-framework','WebKit',str(HERE/'Sources/main.swift'),str(HERE/'Sources/FiMSyntax.swift'),'-o',str(BUILD/('FiMStudio-'+arch))])
